...
-Why?
    - This approach highlights skills that balance market demand and financial reward.It
    weights core skills  appropriately 
*/
SELECT 
    sd.skills,
    ...
    ROUND((MEDIAN(jpf.salary_year_avg)*LN(COUNT(jpf.*))/1_000_000),2) AS optimal_score
        ...
        -- MEDIAN(jpf.salary_year_a)vg) * COUNT(jpf.salary_year_avg) AS  optimal_score
...
*/
/* NOTES
 Natural log is great at compressing large values
--SELECT LN(0);
can't take algorithm of zero
