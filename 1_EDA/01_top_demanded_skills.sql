...
-Identify the top in-demand skills for data engineers
-Focus on remote job postings
-Why?Retrieves the top 10 skills with the highest demand in the remote job providing insights into the most valuable skills for engineers se    
*/  
SELECT 
    sd.skills,
